...
public class CarPage extends BasePage {
    ...
    private WebElement dayPickerElement;
    ...
    public WebElement getDayPickerElement() {
        return dayPickerElement;
    }
    ...
    public void clickPickupTimeBtn() {
